...
public class TestBase {
	...
	public TestBase() {
		try {
		prop = new Properties();
		FileInputStream ip = new FileInputStream("C:\\Users\\ara\\eclipse-workspace\\FreeCRMTest\\src\\main\\java\\com\\crm"
	...
	public static void initialization() {
		...
		driver.manage().timeouts().implicitlyWait(TestUtil.IMPILIC_WAIT, TimeUnit.SECONDS);
